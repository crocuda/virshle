  ...
  outputs = {
    ...
    flake-parts.lib.mkFlake {
      ...
      in rec {
        ...
        flakeModules = rec {
          default = vm;
          vm = ./modules/images/defaultFlakeModule.nix;
        };
        nixosModules = rec {
          default = virshle;
      ...
      in {
        ...
        packages = {
          ...
          vm-xxs-test = self.nixosConfigurations.xxs-test.config.system.build.diskoImages;
          vm-xxs = self.nixosConfigurations.xxs.config.system.build.diskoImages;
          vm-xs = self.nixosConfigurations.xs.config.system.build.diskoImages;
          vm-s = self.nixosConfigurations.s.config.system.build.diskoImages;
